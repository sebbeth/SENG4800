...
namespace visualiser {
	...
	Entity::state_iterator Entity::stateBegin() const {
		return states.begin();
	}
	Entity::state_iterator Entity::stateEnd() const {
		return states.end();
	}

	Entity::frame_iterator Entity::frameBegin() const {
		return frames.begin();
	}
	Entity::frame_iterator Entity::frameEnd() const {
		return frames.end();
	}
